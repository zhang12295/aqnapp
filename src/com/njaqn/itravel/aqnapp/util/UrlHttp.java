...
public class UrlHttp
{
	...
	Thread thread = new Thread(new Runnable()
	{
		...
		try
		{
		    ...
		    {
			throw new Exception("网络出现故障，请稍后");
		    }
     ...
     * @return
     */
    public String postRequest(Map<String, String> params, int pageId, int op)
	    throws Exception
    {
    ...
    public String postRequest(String key, String value, int pageId, int op)
	    throws Exception
    {
    ...
    private void setParams(Map<String, String> paramMap, int pageId, int op)
	    throws Exception
    {
    ...
    private void setParams(String key, String value, int pageId, int op)
	    throws Exception
    {
	StringBuilder data = new StringBuilder();
